          ...
          $.post('buckets.php?a=1',
            ...
            function(data) {
              ...
              if (result.success == 1) {
                ...
                var newBlockLink = '<li> <a href="edit.php?block=' + blockid + '&bucket=' + bucketid + '"> ' + blockid + ' <i class="icon-edit icon-white"></i></a>&nbsp;' + '&nbsp;<a href="javascript:deleteBlock(\'' + blockid + '\', \'' + bucketid + '\')">[X]</a></li>';
        ...
        <div class="modal-body">
          ...
          <p>
            <form id="bucketProperties">
              Bucket Name: <span class="modal-bucket-name"></span>
              <br />
              <span class="control-label">Page Live Edit URL: </span>
        ...
        <div class="modal-body">
          ...
          <p>
            <form id="newBlockProperties">
              ...
              <br /> Block Type: Text
              <br />
              <span class="control-label">Block name:</span>
              <input type="text" id="newblockid" name="newblockid" />
        ...
        <div class="modal-body">
          ...
          <p>
            <form id="deleteBlockProperties">
              Bucket Name: <span class="modal-bucket-name"></span>
              <br /> Block Name: <span class="modal-block-name"></span>
              <br />
